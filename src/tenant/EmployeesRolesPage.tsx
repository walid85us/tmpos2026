...
const EmployeesRolesPage: React.FC = () => {
  return (
    <div className="space-y-8">
      <div>
        <h2 className="text-2xl font-black text-primary tracking-tight">Employee Roles</h2>
        <p className="text-slate-500 font-medium">Define roles for your staff.</p>
      </div>
