...
const SettingsUsersAccessPage: React.FC = () => {
  return (
    <div className="space-y-8">
      <div>
        <h2 className="text-2xl font-black text-primary tracking-tight">Users & Access</h2>
        <p className="text-slate-500 font-medium">Manage store-level user access and security settings.</p>
      </div>
...
export default SettingsUsersAccessPage;
