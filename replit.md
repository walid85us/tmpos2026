...
- **Store Permissions Matrix**: Warranty Management and Suggestive Sales added as assignable module permissions in the Employees → Permissions tab matrix. Connected to `accessConfig.ts` role definitions and plan feature gates.
