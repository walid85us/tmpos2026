...
-   **Phase 1.4** — **Backend & Persistence Readiness** (active, docs/architecture/pure-helper readiness only). **M0 + M1 + M2 + M3 complete/accepted/backed up (`ed86283`); M4 (Provider/Auth Decision Criteria Resolution) active, pending review.** Ratified working directions: **PostgreSQL** as the production database direction and a **server/API tier (managed API layer / serverless / VPS) required for future real enforcement**. **M4 working decision:** **Supabase = preferred default working provider candidate; Firebase Auth retained for testing.** Final Postgres provider (Neon/Railway/Hostinger-VPS = valid fallbacks) and final auth provider remain **provisional** pending product-owner inputs + a backup/restore plan. **Behavior-changing server-side enforcement, Firestore rules, and database migration remain deferred** until the durable data model, request-context, and auth/repository/audit boundaries are implemented and accepted. Artifacts: [`docs/phase-1.4-milestone-0-backend-persistence-readiness.md`](docs/phase-1.4-milestone-0-backend-persistence-readiness.md), [`docs/phase-1.4-milestone-1-auth-repository-boundary-plan.md`](docs/phase-1.4-milestone-1-auth-repository-boundary-plan.md), [`docs/phase-1.4-milestone-2-durable-data-shape-domain-model.md`](docs/phase-1.4-milestone-2-durable-data-shape-domain-model.md), [`docs/phase-1.4-milestone-3-request-context-protected-action-contract.md`](docs/phase-1.4-milestone-3-request-context-protected-action-contract.md), [`docs/phase-1.4-milestone-4-provider-auth-decision-criteria.md`](docs/phase-1.4-milestone-4-provider-auth-decision-criteria.md), [`docs/phase-1.4-decision-record-production-database.md`](docs/phase-1.4-decision-record-production-database.md), [`docs/phase-1.4-decision-record-deployment-topology.md`](docs/phase-1.4-decision-record-deployment-topology.md).
