...
- **POS Cash Rounding**: Optional "Round up cash" toggle appears below Cash payment input. Calculates rounded amount based on total minus other payments (not remaining). Shows change amount. Card payments stay exact-only.
