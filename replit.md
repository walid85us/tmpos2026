...
-   **Phase 1.4** — **Backend & Persistence Readiness** (active, docs/architecture/pure-helper readiness only). **M0 + M1 + M2 + M3 + M4 + M5 complete/accepted/backed up (`cdd1c03`); M6 (Backend & Persistence Readiness Closeout Package) active, pending review.** Ratified working directions: **PostgreSQL** as the production database direction and a **server/API tier (managed API layer / serverless / VPS) required for future real enforcement**. **M4 working decision:** **Supabase = preferred default working provider candidate; Firebase Auth retained for testing.** **M5 gate:** final Postgres provider (Neon/Railway/Hostinger-VPS = valid fallbacks) and final auth provider remain **provisional until the M5 finalization gate is satisfied** — product-owner input checklist, per-dimension + per-provider + per-auth go/no-go, minimum evidence package, and a backup/restore plan; **no backend/provider/auth implementation may begin before the gate inputs are answered.** **M6 closeout** consolidates M0–M5 into one authoritative handoff and names **Product Owner Input Collection** as the recommended next step. **Behavior-changing server-side enforcement, Firestore rules, and database migration remain deferred** until the durable data model, request-context, and auth/repository/audit boundaries are implemented and accepted. Artifacts: [`docs/phase-1.4-milestone-0-backend-persistence-readiness.md`](docs/phase-1.4-milestone-0-backend-persistence-readiness.md), [`docs/phase-1.4-milestone-1-auth-repository-boundary-plan.md`](docs/phase-1.4-milestone-1-auth-repository-boundary-plan.md), [`docs/phase-1.4-milestone-2-durable-data-shape-domain-model.md`](docs/phase-1.4-milestone-2-durable-data-shape-domain-model.md), [`docs/phase-1.4-milestone-3-request-context-protected-action-contract.md`](docs/phase-1.4-milestone-3-request-context-protected-action-contract.md), [`docs/phase-1.4-milestone-4-provider-auth-decision-criteria.md`](docs/phase-1.4-milestone-4-provider-auth-decision-criteria.md), [`docs/phase-1.4-milestone-5-provider-finalization-gate.md`](docs/phase-1.4-milestone-5-provider-finalization-gate.md), [`docs/phase-1.4-milestone-6-backend-persistence-readiness-closeout.md`](docs/phase-1.4-milestone-6-backend-persistence-readiness-closeout.md), [`docs/phase-1.4-decision-record-production-database.md`](docs/phase-1.4-decision-record-production-database.md), [`docs/phase-1.4-decision-record-deployment-topology.md`](docs/phase-1.4-decision-record-deployment-topology.md).
