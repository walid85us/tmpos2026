...
-   **Current phase**: Phase 1.3 — Platform Team Governance (server-side RBAC / PIM / PAM). **Milestone 0 (Current Access Inventory), Milestone 1 (advisory governance model), and Milestone 2 (Platform Team Directory + Role Matrix UI) are complete, accepted, and backed up.** **Milestone 3 (Temporary Access / PIM Foundation) is the current active workstream** — a local, advisory, non-enforcing request → approve/grant → revoke (plus deny/cancel) workflow in Team Management, built on the Milestone 1 `TemporaryAccessGrant` types via the new `src/owner/platformTemporaryAccess.ts` store (session-scoped, derived/lazy expiry, no scheduler, reason-required, never applied to the live resolver). **Milestone 4 (access review + reason capture) and Milestone 5 (Command Center / Audit integration) are not started. Phase 1.3 is not complete.** Authoritative artifacts: Milestone 0 inventory [`docs/phase-1.3-platform-access-inventory.md`](docs/phase-1.3-platform-access-inventory.md), Milestone 1 model [`docs/phase-1.3-platform-team-governance-model.md`](docs/phase-1.3-platform-team-governance-model.md), Milestone 2 UI [`docs/phase-1.3-milestone-2-team-directory-role-matrix-ui.md`](docs/phase-1.3-milestone-2-team-directory-role-matrix-ui.md), Milestone 3 foundation [`docs/phase-1.3-milestone-3-temporary-access-pim-foundation.md`](docs/phase-1.3-milestone-3-temporary-access-pim-foundation.md).
...
-   **Phase 1.3** — Platform Team Governance (server-side RBAC / PIM / PAM) **(in progress — M0/M1/M2 complete & accepted; M3 Temporary Access / PIM Foundation active; M4/M5 not started; phase not complete)**
