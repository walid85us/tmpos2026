...
- **POS Catalog**: Add Item modal has repair services as base items + all products from approvedStockItems only (no hardcoded product entries). Exact SKU match prioritized.
